...
public class BrokenBonesEffect extends MoodleEffect{
    public static String NAME = "brokenbones";
    public static int ID;
    //be sure to add multiple for amps

    public BrokenBonesEffect(int id) {
        super(id, false, 0xFFFFFF);
        this.setPotionName("potion." + NAME);
        ID = id;
        //set up fields
        moodleFields.put(1, new String[] {"Fractures","Painful."});
        moodleFields.put(2, new String[] {"Broken Legs","Falls hurt."});
